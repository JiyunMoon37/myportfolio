...
cell_conf_int = np.exp(model.conf_int().loc['CELL'])

print(f"CELL 변수의 오즈비: {cell_odds_ratio:.4f}")
print(f"CELL 변수의 99% 신뢰구간: ({cell_conf_int[0]:.4f}, {cell_conf_int[1]:.4f})")

#CELL 변수의 오즈비: 24508982903971.1094
#CELL 변수의 99% 신뢰구간: (0.0000, 5847804413418762520297359678803551561676849915343061123072.0000)
```
